...
import { Brain, ArrowRight, Loader2, Lock, Mail, User, Eye, EyeOff } from "lucide-react";
...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(formatError(err, "Registration failed. Please check your data and try again."));
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="flex min-h-screen bg-neutral-950 text-neutral-100 flex-col items-center justify-center p-6 relative selection:bg-indigo-500 selection:text-white">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-neutral-400 text-sm mt-1">Get started with your operations workspace</p>
        </div>
